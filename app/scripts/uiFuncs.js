    ...
    try {
        ...
        var genTxWithInfo = function(data) {
            var rawTx = {
                ...
                nrgPrice: data.isOffline ? ethFuncs.sanitizeHex(data.gasprice) : ethFuncs.sanitizeHex(ethFuncs.addTinyMoreToGas(data.gasprice)),
                nrgLimit: ethFuncs.sanitizeHex(ethFuncs.decimalToHex(txData.gasLimit)),
