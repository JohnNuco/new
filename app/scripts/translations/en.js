...
GAS_LIMIT_Desc                  :  'NRG limit is the amount of NRG to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending ETH = `21000`. Sending Tokens = ~`200000`.',
GAS_PRICE_Desc                  :  'NRG Price is the amount you pay per unit of NRG. `TX fee = NRG price * NRG limit` & is paid to miners for including your TX in a block. Higher the NRG price = faster transaction, but more expensive. Default is `41 GWEI`.',
...
GEN_Help_12                     :  'Use it to unlock your wallet via My Aion Wallet',
...
NAV_ENS                         :  'ENS',
NAV_GenerateWallet              :  'Create New Aion Wallet',
...
NAV_SendEther                   :  'Send Aions',
NAV_SendTokens                  :  'Send Aions',
...
OFFLINE_Step2_Label_3           :  'NRG Price',
...
x_Access                        :  'Access',
x_AddessDesc                    :  'Your Address can also be known as your `Account #` or your `Public Key`. It is what you share with people so they can send you Aions. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
